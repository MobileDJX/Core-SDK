...
public class AdRequestParam extends Config {
    ...
    public AdRequestParam GenerateRequestURL(Device_settings dInfo, AdsInitialize imgad) {
...
//
//
//        h_params.put("viewerage", "20");
//        h_params.put("viewerGender", "Male");
        ...
        h_params.put("displaywidth", "");
        h_params.put("displayheight", "");
        ...
        h_params.put("latitude", "");
        h_params.put("longitude", "");


//        h_params.put("device_email", String.valueOf(dInfo.user_email));
//        h_params.put("Dmp_id", String.valueOf(dInfo.getGAID()));
//        h_params.put("userid", "12345");
//        h_params.put("ip", Utils.getLocalIpAddress());
