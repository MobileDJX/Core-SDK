...
//                                String
                                ...
                                //Banner Image Ad
                                    ...
                                    String landScape_banner = null;
                                    int adRefresh = 0;
                                    if (jsonObj.getString("ad_check").equalsIgnoreCase("1")) {
                                        Log.e("BannerImageAD Status", "AD SHOWN..");
                                        bannerImage = jsonObj.getString("ad_tag");
//                                        landScape_banner = jsonObj.getString("NarrowImage");
                                        adRefresh = Integer.parseInt(jsonObj.getString("Refresh_time_seconds"));
                                    } else {
                                        Log.e("BannerImageAD Status", "AD NOT SHOWN..");
                                    }

                                    new LoadData().saveVideoBannerAdType(context, ad_type);
                                    new LoadData().saveBannerImage(context, bannerImage, "landScape_banner", adRefresh);
                                }
                                ...
                                //Interstitial Video Ads
                                    ...
                                    String int_videoTag = null, screenType = null, destination_url = null, logo_url = null;

                                    if (ad_check.equalsIgnoreCase("1")) {
                                        int_videoTag = jsonObj.getString("ad_tag");

                                        screenType = jsonObj.getString("layout");
                                        destination_url = jsonObj.getString("click_url");
                                        logo_url = jsonObj.getString("logourl");
                                        Log.d("Interstitial Ads : ", int_videoTag);
                                    ...
                                    new LoadData().saveInterstitialVideo(context, int_videoTag, screenType, ad_check, destination_url, logo_url);

                                } else if (ad_type.equalsIgnoreCase("Video Ads")) {


                                    String adTag = jsonObj.getString("ad_tag");

                                    int adRefresh = Integer.parseInt(jsonObj.getString("Refresh_time_seconds"));


                                    new LoadData().saveVideoBannerAdType(context, ad_type);

                                    new LoadData().saveVideoAds(context, adTag, adRefresh);
                            ...
                            Log.e("AdResponse", "Response Error" + e.getMessage());
