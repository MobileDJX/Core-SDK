...
public class AdsInitialize extends FrameLayout {
    ...
    public AdsInitialize(Context context, String publisher_id, AdViewListener listener) {
        super(context);
        setup(context, null);
    ...
    private void setup(Context context, AttributeSet attrs) {
        ...
        mAdFetcher = new AdFetcher(AdsInitialize.this);
    ...
    public void LoadAd() {
        ...
        if (this.adViewContext != null) {
            ...
            if (isInternetPresent) {
                ...
                dispatcher.internet_connection_failed(AdsInitialize.this, true);
                Toast.makeText(adViewContext, "No Internet", Toast.LENGTH_SHORT).show();

                Toast.makeText(adViewContext, "Check the Internet Connection", Toast.LENGTH_LONG).show();
            }
    ...
    class AdListenerDispatch implements AdListener {
        ...
        @Override
        public void param_required(final AdsInitialize ad, final boolean flag) {
        ...
        @Override
        public void internet_connection_failed(final AdsInitialize ad, final boolean flag) {
            // TODO Auto-generated method stub
            handler.post(() -> {
                if (adListen != null) {
        ...
        @Override
        public void load_ad_failed(final AdsInitialize ad, final boolean flag, final String ecode,
                                   final String edesc) {
            // TODO Auto-generated method stub
            handler.post(() -> {
                if (adListen != null) {
