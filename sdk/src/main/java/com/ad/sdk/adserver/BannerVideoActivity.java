...
public class BannerVideoActivity implements Player.Listener {
...
//    }
    ...
    public void initializePlayer(Context context, StyledPlayerView playerView) {
        ...
        SharedPreferences sharedPreferences = context.getSharedPreferences("VideoBanner", Context.MODE_PRIVATE);
        String ad_url = sharedPreferences.getString("adTag", "");
