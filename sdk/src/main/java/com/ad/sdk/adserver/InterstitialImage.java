...
public class InterstitialImage {
    ...
    public static void show(Context context, InterstitialAdShowListener interstitialImageAdListener) {
        try {
...
//                Glide.with(context).load(logoURL).into(logo);
                ...
                if (HtmlCode.length() > 0) {
                    ...
                    interstitialImageAdListener.onAdsShowStart();
                    ...
                    webView.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            interstitialImageAdListener.onAdsShowClick();

                        }
                    });

                    interstitialImageAdListener.onAdsShowComplete();
                    ...
                    close.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            interstitialImageAdListener.onAdsDismissed();
            ...
            interstitialImageAdListener.onAdsShowFailure();
        }
