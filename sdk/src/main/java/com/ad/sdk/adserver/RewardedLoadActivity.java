...
//        rewardGranted = findViewById(R.id.rewardGranted);
        ...
        count = 0;
        if (RewardedVideo.rewardedListener != null) {
            RewardedVideo.rewardedListener.onAdsAdLoaded();
        }
        ...
        ((ImageView) findViewById(R.id.img_close_btn)).setOnClickListener(view -> {
            ...
            if (!(netInfo == null)) {
                if (!videoError) {
                    if (RewardedVideo.rewardedshowListener != null) {
//                        RewardedVideo.rewardedshowListener.Rewarded("Reward Points", amount);
                        Log.e("Ad", ":" + "Completed");
                    }
                }
            }
...
//                    suggestionPart.setVisibility(View.VISIBLE);
                    RewardedVideo.rewardedshowListener.onAdsShowStart();
                    Log.e("Ad", ":" + "Started");
