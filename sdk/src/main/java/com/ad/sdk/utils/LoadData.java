...
public class LoadData {
    ...
    public void saveAdType(Context context, String adTYPE) {
        SharedPreferences sharedPreferences = context.getSharedPreferences("ADType", MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedPreferences.edit();
    ...
    public String getAdType(Context context) {
        ...
        adTYPE = sharedPreferences.getString("ad_type", "NO Interstitial Ads");
    ...
    public String getInterstitialVideo(Context context) {
        ...
        SharedPreferences sharedPreferences = context.getSharedPreferences("InterstitialVideo", MODE_PRIVATE);
        videoURL = sharedPreferences.getString("InterstitialVideo", "No url");
    ...
    //Save Banner Image
    public void saveBannerImage(Context context, String url, String landscapeURL, int adRefresh) {
        SharedPreferences sharedPreferences = context.getSharedPreferences("BannerAds", MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedPreferences.edit();

        editor.putString("BannerImageADTAG", url);
        editor.putString("LandscapeBannerADTAG", landscapeURL);
        editor.putInt("AdRefreshTime", adRefresh);
        editor.apply();
    }
    ...
    public String loadLandscapeBannerImage(Context context) {
        SharedPreferences sharedPreferences = context.getSharedPreferences("BannerAds", MODE_PRIVATE);
        String imageUrl = null;
        imageUrl = sharedPreferences.getString("LandscapeBannerADTAG", "");
        return imageUrl;
    }
    ...
    //Banner VideoAds start


    public void saveVideoBannerAdType(Context context, String adTYPE) {
        SharedPreferences sharedPreferences = context.getSharedPreferences("VideoBannerADType", MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedPreferences.edit();
        editor.putString("ad_type", adTYPE);
        editor.apply();
    }

    public String getVideoBannerAdType(Context context) {
        String adType = null;
        SharedPreferences sharedPreferences = context.getSharedPreferences("VideoBannerADType", MODE_PRIVATE);
        adType = sharedPreferences.getString("ad_type", "noadtype");
        return adType;

    }


    public void clearVideoBannerAdTag(Context context) {
        SharedPreferences sharedPreferences = context.getSharedPreferences("VideoBannerADType", MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedPreferences.edit();
        editor.clear();
        editor.apply();
    ...
    public void saveVideoAds(Context context, String adTag, int refreshTime) {
        SharedPreferences sharedPreferences = context.getSharedPreferences("VideoBanner", MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedPreferences.edit();
        editor.putString("adTag", adTag);
        editor.putInt("refreshTime", refreshTime);
        editor.apply();
    }

    public void clearVideoBannerAds(Context context) {
        SharedPreferences sharedPreferences = context.getSharedPreferences("VideoBanner", MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedPreferences.edit();
        editor.clear();
        editor.apply();
    ...
    public void logoutClear(Context context) {
        ...
        clearVideoBannerAdTag(context);
        clearVideoBannerAds(context);
    }
